...
public class MapsActivityCurrentPlace extends AppCompatActivity
    ...
    // not granted.
    private final LatLng mDefaultLocation = new LatLng(30.27, -97.74);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String response;
        try {
            response = run("https://powerful-bayou-61346.herokuapp.com/");
        }
        catch(IOException e){
            e.printStackTrace();
            response = "None";
        ...
        //response = "30.27 -97.74 -33.852 151.211";
        Scanner parse = new Scanner(response);
        parse.useDelimiter("%");
        while (parse.hasNext()){
        ...
        for(int i=0;i<count;i++){
            System.out.println(name[count]+" "+lat[count]+", "+lon[count]);
            coord[i]= new LatLng(lat[i],lon[i]);
        }
